...
def save_grade_report(score, letter_grade, gpa, name="", subject=""):
    try:
        ...
        with open("grade_history_v1_0_7.txt", "a", encoding="utf-8") as f:
            f.write(f"\n{'='*60}\n")
            f.write(f"Test Grader v1.0.7 - Grade Report\n")
...
<html>
<head>
    <title>Test Grader v1.0.7 - Web Server</title>
    <style>
...
<body>
    <div class="container">
        <h1>📊 Test Grader v1.0.7</h1>
        <p>Original basic version</p>
