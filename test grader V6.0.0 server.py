...
def save_grade_report(score, letter_grade, gpa, name="", subject=""):
    try:
        ...
        with open("grade_history_v6.txt", "a", encoding="utf-8") as f:
            f.write(f"\n{'='*60}\n")
            f.write(f"Test Grader v6.0.0 - Grade Report\n")
...
<html>
<head>
    <title>Test Grader v6.0.0 - Web Server</title>
    <style>
...
<body>
    <div class="container">
        <h1>📊 Test Grader v6.0.0</h1>
        <p>Full-featured with visual feedback and progress bar</p>
