...
HTML_TEMPLATE = """<!DOCTYPE html><html><head><title>Grader 5079</title><style>
...
</style></head><body><div class="container"><h1>📊 Server 5079</h1>
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5079, debug=False)
