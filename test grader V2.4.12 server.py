...
def save_grade_report(score, letter_grade, gpa, name="", subject=""):
    try:
        ...
        with open("grade_history_v2_4_12.txt", "a", encoding="utf-8") as f:
            f.write(f"\n{'='*60}\n")
            f.write(f"Test Grader v2.4.12 - Grade Report\n")
...
<html>
<head>
    <title>Test Grader v2.4.12 - Web Server</title>
    <style>
...
<body>
    <div class="container">
        <h1>📊 Test Grader v2.4.12</h1>
        <p>Input validation and grade boundaries reference</p>
