...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'v13-secret-key-change-in-production'
...
<html>
<head>
    <title>Test Grader v13.0.0 - Account Manager</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div id="dashboard" class="dashboard">
            ...
            <button onclick="window.location.href='/grader'">Go to Grader (Charts & Analytics)</button>
...
@app.route('/grader')
def grader():
    return '<h1>v13.0.0 Grader - Charts & Analytics</h1><p>Ultimate edition with graphical analytics</p><a href="/">Back</a>'

if __name__ == '__main__':
    app.run(host='0.0.0.0', port=6013, debug=False)
