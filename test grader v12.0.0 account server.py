...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'v12-secret-key-change-in-production'
...
<html>
<head>
    <title>Test Grader v12.0.0 - Account Manager</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div id="dashboard" class="dashboard">
            ...
            <button onclick="window.location.href='/grader'">Go to Grader (CSV Export)</button>
...
@app.route('/grader')
def grader():
    return '<h1>v12.0.0 Grader - CSV Export</h1><p>Professional edition with CSV export</p><a href="/">Back</a>'
