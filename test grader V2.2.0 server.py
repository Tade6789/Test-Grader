...
def save_grade_report(score, letter_grade, gpa, name="", subject=""):
    try:
        ...
        with open("grade_history_v2_2_0.txt", "a", encoding="utf-8") as f:
            f.write(f"\n{'='*60}\n")
            f.write(f"Test Grader v2.2.0 - Grade Report\n")
...
<html>
<head>
    <title>Test Grader v2.2.0 - Web Server</title>
    <style>
...
<body>
    <div class="container">
        <h1>📊 Test Grader v2.2.0</h1>
        <p>Updated grading scale and feedback messages</p>
